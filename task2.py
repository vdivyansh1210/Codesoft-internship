...
label_result = Label(root,width=25,height=2, text="",font=("ms sans serif",33,"bold"))
label_result.pack()

Button(root,text="C", width=5,height=1, font=("System",30,"bold"),bd=1,fg="#fff",bg="#3697f5",command=lambda: clear()).place(x=10,y=100)
